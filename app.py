...
def procurar_regex(nomes):
	...
	regex = raw_input()
	resultados = re.findall(regex, nomes_concat)
	print resultados
...
def menu():
	...
	escolha = ''
	while(escolha != '0'):    
		print 'Digite: 1 para cadastrar, 2 para listar, 3 para remover nome, 4 para alterar, 5 para procurar, 6 busca por semalhança, 0 para terminar'
		escolha = raw_input()
		if(escolha == '1'):
			cadastrar(nomes)
